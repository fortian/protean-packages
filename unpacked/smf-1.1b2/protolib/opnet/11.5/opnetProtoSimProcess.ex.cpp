...
printf("\tOpnetProtoSimProcess::UdpSocketProxy::RecvFrom\n"); 
    ...
    if (recv_data)
    {
        ...
        {
            DMSG(0, "OpnetProtoSimProcess::UdpSocketProxy::RecvFrom buffer too small\n");
            numBytes = 0; 
            return false;    
        }        
    }
    ...
    {
        DMSG(4, "OpnetProtoSimProcess::UdpSocketProxy::RecvFrom no data ready\n");
        numBytes = 0; 
        return false;       
    }   
                                                    ...
                                                    ProtoAddress& srcAddr)
{
    if (recv_data)
    {
        ...
        {
            DMSG(0, "OpnetProtoSimProcess::TcpSocketProxy::RecvFrom buffer too small\n");
            numBytes = 0; 
            return false;    
        }        
    }
    ...
    {
        DMSG(4, "OpnetProtoSimProcess::TcpSocketProxy::RecvFrom no data ready\n");
        numBytes = 0; 
        return false;       
    }   
}
