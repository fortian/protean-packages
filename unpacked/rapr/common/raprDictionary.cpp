...
RaprStringVector *RaprDictionary::SystemNameSpace(char *inVal, RaprDictionaryTransfer *trans,char *arg) {
...
RaprStringVector *RaprDictionary::PacketNameSpace(char *inVal, RaprDictionaryTransfer *trans) {
...
//translate is called.
RaprStringVector *RaprDictionary::namevalue(char *inNS,char *inVal,RaprDictionaryTransfer *trans, char *arg) {
...
RaprStringVector *RaprDictionary::translate(char *baseString) {
	return translate(baseString,NULL);
}

RaprStringVector *RaprDictionary::ParseNestedField(char *buf,char *name,RaprDictionaryTransfer *trans)
{
  char *buf1,*buf2;
...
RaprStringVector *RaprDictionary::ParseNestedField(char *buf,int y,RaprDictionaryTransfer *trans)
{
  char *buf1,*buf2,*buf3;
...
RaprStringVector *RaprDictionary::translate(char *baseString,RaprDictionaryTransfer *trans) 
{
...
int RaprDictionary::count(char *inString,char inSep) {
	int z=0;
	char *tmp = strchr(inString,inSep);
	while (tmp != NULL) {
		z++;
...
int RaprDictionary::location(char *inString,char inSep) {
	char *tmp = strchr(inString,inSep);
	return tmp-inString;
}
